...
import { ChatRenderer, type TurnOutcome, renderMarkdown } from "./render.js";
...
function printApiError(err: ApiError): void {
...
async function printHistory(client: DigenClient, conversationId: string): Promise<void> {
  try {
